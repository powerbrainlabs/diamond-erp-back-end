...
async def seed_default_category_schemas(db):
    ...
    schemas.append({
        ...
        "description": "Single gemstone in setting",
        "description_template": "One {metal} {category} studded with {gemstone_piece} Natural {gemstone}.",
    ...
    schemas.append({
        ...
        "description": "Two gemstones in setting",
        "description_template": "One {metal} {category} studded with {primary_gemstone_piece} Natural {primary_gemstone} and {secondary_gemstone}.",
